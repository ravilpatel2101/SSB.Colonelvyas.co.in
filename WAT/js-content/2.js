...
document.write( '          <li>You can practice for WAT over here for unlimited times.</li>\n' );
document.write( '          <li>Use full screen for best result and mobile users can use landscape orientation for best performance.</li>\n' );
document.write( '          <li>You may download PDF of all words to practice after the mock using this <a href=\"/PDF/MOCK-2.pdf\" target=\"_blank\" style=\"text-decoration: none;\"> link</a></li>\n' );
